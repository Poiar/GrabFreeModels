      ...
      <TransitionGroup name="toast">
        ...
        >
          <span class="toast-icon" aria-hidden="true">
            ...
            <svg v-else-if="toast.type === 'info'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
...
.toast-info { border-left: 3px solid var(--accent, #6380f7); }
...
.toast-success .toast-icon { color: var(--green, #34d399); }
.toast-error .toast-icon { color: var(--red, #f87171); }
.toast-info .toast-icon { color: var(--accent, #6380f7); }
