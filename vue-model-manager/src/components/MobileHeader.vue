<template>
  <header class="mobile-header">
    <button class="hamburger" @click="emit('toggle')" :aria-label="open ? 'Close navigation' : 'Open navigation'" :aria-expanded="open">
    ...
    <span class="brand-name">GrabFreeModels</span>
    <button class="mobile-theme-toggle" @click="emit('toggleTheme')" :aria-label="theme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'">
...
const emit = defineEmits<{ (e: 'toggle'): void; (e: 'toggleTheme'): void }>()
</script>
