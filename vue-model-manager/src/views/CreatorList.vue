...
<style scoped>
.creator-list-page { max-width: 1200px; margin: 0 auto; padding: 20px; }
...
.creator-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 12px; margin-top: 16px; }
...
.creator-card:hover { border-color: var(--accent); box-shadow: 0 0 0 1px var(--accent); }

.cc-name { font-size: 1rem; font-weight: 700; margin: 0 0 8px; }
.cc-stats { display: flex; gap: 12px; margin-bottom: 6px; }
.cc-stat { font-size: 0.78rem; color: var(--text-muted); }
.cc-top { font-size: 0.72rem; color: var(--accent); }
