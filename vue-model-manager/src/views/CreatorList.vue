<template>
  <div class="creator-list-page">
    ...
    <div class="cc-continent-filters">
      ...
      >{{ c === 'All' ? `All (${store.visibleCreators.length})` : `${c} (${continentCount(c)})` }}</button>
    </div>
...
const filteredCreators = computed(() => {
  if (selectedContinent.value === 'All') return store.visibleCreators;
  return store.visibleCreators.filter(
