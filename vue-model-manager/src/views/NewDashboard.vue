...
<style scoped>
.new-dashboard { max-width: 1200px; margin: 0 auto; padding: 20px; }
...
.stale-banner {
  ...
  background: rgba(251, 191, 36, 0.1); border: 1px solid var(--orange); border-radius: 8px;
  font-size: 0.78rem; color: var(--orange);
}

.stats-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(130px, 1fr)); gap: 8px; margin-bottom: 24px; }
.stat-card { padding: 14px 16px; border: 1px solid var(--border); border-radius: 8px; background: var(--bg-card); text-align: center; }
...
.provider-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 8px; margin-bottom: 24px; }
.provider-card { padding: 12px; border: 1px solid var(--border); border-radius: 8px; background: var(--bg-card); }
...
.prov-name { font-size: 0.82rem; font-weight: 600; margin-bottom: 4px; }
.prov-stats { display: flex; align-items: center; gap: 6px; margin-bottom: 6px; }
.prov-count { font-size: 0.78rem; font-weight: 700; color: var(--green); }
...
.prov-bar-track { height: 4px; background: var(--bg-elevated); border-radius: 2px; overflow: hidden; margin-bottom: 4px; }
.prov-bar-fill { height: 100%; background: var(--green); border-radius: 2px; transition: width 0.3s; }
.prov-total { font-size: 0.68rem; color: var(--text-muted); }

.card { padding: 16px; border: 1px solid var(--border); border-radius: 8px; background: var(--bg-card); margin-bottom: 16px; }
.card-title { font-size: 0.9rem; font-weight: 700; margin-bottom: 8px; }
.card p { font-size: 0.78rem; color: var(--text-muted); margin: 4px 0; }

table { width: 100%; font-size: 0.78rem; }
th, td { padding: 6px 10px; text-align: left; border-bottom: 1px solid var(--border); }
th { color: var(--text-muted); font-weight: 600; font-size: 0.72rem; }

.refresh-btn { padding: 4px 10px; font-size: 0.68rem; border: 1px solid var(--border); border-radius: 6px; background: var(--bg-elevated); color: var(--text); cursor: pointer; font-family: inherit; }
