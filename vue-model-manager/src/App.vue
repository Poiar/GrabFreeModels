      ...
      <nav aria-label="Main navigation">
          ...
          <router-link to="/dashboard" :class="{ active: isNavActive('/dashboard') }">
            <span class="nav-icon">
              <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <line x1="4" y1="20" x2="4" y2="12" /><line x1="9" y1="20" x2="9" y2="6" /><line x1="14" y1="20" x2="14" y2="14" /><line x1="19" y1="20" x2="19" y2="9" /><line x1="2" y1="20" x2="22" y2="20" />
              </svg>
            </span>
            <span>Dashboard</span>
          </router-link>
        ...
        <div class="nav-section models">
          ...
          <router-link to="/picker" :class="{ active: isNavActive('/picker') }">
            <span class="nav-icon">
              <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M4 7V4h16v3"/><path d="M9 20h6"/><path d="M12 4v16"/><polyline points="8 11 12 15 16 11"/>
              </svg>
            </span>
        ...
        <div class="nav-section providers">
          ...
          <router-link to="/compare-providers" :class="{ active: isNavActive('/compare-providers') }">
            <span class="nav-icon">
              <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <router-link to="/providers/onboarding" :class="{ active: isNavActive('/providers/onboarding') }">
            <span class="nav-icon">
              <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="nav-section catalog">
          ...
          <router-link to="/families" :class="{ active: isNavActive('/families') }">
            <span class="nav-icon">
              <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="9" cy="7" r="3" /><circle cx="17" cy="7" r="3" /><circle cx="13" cy="17" r="3" /><line x1="10.5" y1="9.5" x2="12.5" y2="14.5" /><line x1="15.5" y1="9.5" x2="13.5" y2="14.5" />
              </svg>
            </span>
            <span>Families</span>
          </router-link>
        ...
        <div class="nav-section tools" :class="{ collapsed: toolsCollapsed }">
          <button class="nav-section-header nav-section-toggle" @click="toolsCollapsed = !toolsCollapsed" :aria-expanded="!toolsCollapsed">
            <span>Tools</span>
            <svg class="toggle-chevron" :class="{ open: !toolsCollapsed }" aria-hidden="true" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
