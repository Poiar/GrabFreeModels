...
const LIMITS = {
  ...
  'zai-coding-plan': { rate_limit: 'Varies by model', notes: 'Free tier via Z.ai coding plan. Requires account.' },
  ...
  zai: { rate_limit: 'Varies by model', notes: 'Free tier via Z.ai. Requires account.' },
