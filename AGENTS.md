...
- **Frontmatter stays concise**: Skill descriptions mention _what_ triggers them, not implementation details.
...
| `backfill-metadata.js`             | Read/write DB. Sets `supports_tools` based on known model patterns                                                                                                  |
